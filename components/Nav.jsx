...
const Nav = () => {
  return (
	...
	<aside className="bg-blue-600 space-x-4 md:space-x-0 justify-center md:justify-start flex md:flex-col md:w-[20vw] md:space-y-6 md:h-[100vh] px-4 py-8">
			...
			<Link href="/" className=" p-2 rounded-[50%] md:pl-2 info flex cursor-pointer items-center space-x-4">
		...
		<Link href="/select" className="info p-2 rounded-[50%] md:pl-2  flex cursor-pointer items-center space-x-4">
		...
		<Link href="/addOn" className="info p-2 rounded-[50%] md:pl-2  flex cursor-pointer items-center space-x-4">
		...
		<Link href="/thank" className="info p-2 rounded-[50%] md:pl-2  flex cursor-pointer items-center space-x-4">
