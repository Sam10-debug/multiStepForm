...
const Thank = () => {
  return (
	<section className="px-12 py-8 flex justify-center space-y-4 items-center flex-col">
		...
		<p className="md:w-1/2 text-center">Thanks for confirming your subscription. we hope you have fun using our platform. If you ever need support feel free to email us at support@loremgaming.com.</p>
	</section>
  )
}
